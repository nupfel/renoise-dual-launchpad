...
duplex_configurations:insert {
  ...
  device = {
    ...
    display_name = "Launchpad rotated",
    device_port_in = "Launchpad rotated",
    device_port_out = "Launchpad rotated",
    control_map = "Controllers/Launchpad/Launchpad_rotated.xml",
